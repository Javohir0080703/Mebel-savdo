...
const Promotion = () => {
      ...
      const filteredData = homedata.filter(item => item.skidka.length > 0);
  ...
  return (
    <section className='py-10'>
        <div className='containerb'>
           <h1 className='text-center text-5xl font-semibold mb-16'>Promotion</h1>
           <ul>
                        ...
                        >
                            <Link >
                                ...
                                <div>
                                   ...
                                   <strike className={`text-#414141 font-medium text-base leading-5  ${hoveredItem === item ? 'mb-2' : 'mb-0'}`}>
                                        {item.narx}
                                    </strike>
                                    <p>{item.skidka}</p>
                                   </div>
